...
description: Quy chuẩn và quy trình xây dựng các tính năng Frontend (Module-based). Đảm bảo tính nhất quán về UI/UX, Type Safety và API Integration.
---
...
- **Status Badges**: Dùng màu sắc chuẩn (blue=new, emerald=active/won, amber=proposal). Xem `references/ui-layout.md`.
