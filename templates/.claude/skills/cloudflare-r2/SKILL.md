---
name: cloudflare-r2
description: Dùng skill cloudflare-r2 để triển khai object storage tương thích S3 không phí egress - upload/download files, migration, cấu hình buckets, tích hợp Workers.
---
