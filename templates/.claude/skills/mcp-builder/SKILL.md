---
name: mcp-builder
description: Dùng skill mcp-builder để tạo MCP (Model Context Protocol) servers chất lượng cao - tích hợp external APIs/services với Python (FastMCP) hoặc TypeScript (MCP SDK).
