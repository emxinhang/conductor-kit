...
description: Dùng skill postgresql-psql để làm việc với PostgreSQL qua psql terminal - execute queries, manage databases/tables, transactions, scripting, database administration.
license: PostgreSQL
version: 1.0.0
---
