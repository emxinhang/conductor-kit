...
- `.agents/skills/` — Gemini AG: `atu-conductor`, `atu-new-conversation`, `atu-update-knowledge`, `atu-handoff`, `brainstorm-track`, `planner-track`, `module-workflow`, `refactor-workflow`, `qa-verify-expert`, `frontend-standard-v1`, `zero-loop-dev`, `deploy-track`, `done-checklist`
- `.claude/skills/` — Claude CS: `conductor`, `new-conversation`, `update-knowledge`, `handoff`, `brainstorm-track`, `planner-track`, `module-workflow`, `refactor-workflow`, `qa-verify-expert`, `frontend-standard-v1`, `zero-loop-dev`, `deploy-track`, `done-checklist`
...
**Contract-First Framework** (installed into `docs/contracts/` + `scripts/contracts/`):
- `docs/contracts/FRAMEWORK.md` — how-to: capture + design-first workflows
- `docs/contracts/_registry.md` — index tất cả contracts + breaking change log
- `scripts/contracts/capture.py` — export live OpenAPI → yaml
- `scripts/contracts/validate.py` — diff live API vs committed spec
- `docs/skill-update-guide.md` — hướng dẫn cho AI khác cập nhật skills
