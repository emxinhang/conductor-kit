...
Whenever a backend schema changes, manually invoke this skill or ask AG to:
1. "Verify the contract for `EntityX` between Backend and Frontend."
2. AG will read the Backend Schema, read the Frontend Type, and point out any missing or typed-wrong fields.

### Phase 3: Behavior Verification (The Acid Test)
Before declaring "Track Done", ask AG to write a short Verification Script.
