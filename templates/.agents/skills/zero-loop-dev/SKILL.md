...
- **Backend API**: Chạy `python .agents/skills/zero-loop-dev/scripts/verify_integrity.py` sau mỗi entity mới để check import & schemas
...
### Scaffold entity mới
```bash
python .agents/skills/zero-loop-dev/scripts/scaffold_backend.py [entity_name]
```
