...
description: Dùng skill inversion-exercise để đảo ngược assumptions và tìm ra hidden constraints và alternative approaches - 'what if the opposite were true?'
