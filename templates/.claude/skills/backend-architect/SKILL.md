...
description: Design reliable backend systems with focus on data integrity, security, and fault tolerance. Use for API development, database design, security implementation.
---
