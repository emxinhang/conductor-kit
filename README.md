...
This kit packages the Conductor workflow runtime + full skill library for 3 CLI tools in a single portable git repo.
...
- `.agents/skills/` — Gemini AG: core workflow + execution skills
- `.claude/skills/` — Claude CS: full skill library (58 skills across workflow, architecture, debugging, tools, and thinking frameworks)
- `.codex/skills/` — Codex CD: core workflow skills
...
**.agents/skills/**
- Core workflow: `atu-conductor`, `atu-new-conversation`, `atu-update-knowledge`, `atu-handoff`
- Track: `brainstorm-track`, `planner-track`, `module-workflow`, `refactor-workflow`
- QA: `qa-verify-expert`, `frontend-standard-v1`
- Execution: `zero-loop-dev`, `deploy-track`

**.claude/skills/** *(expanded in v3.5 — 58 skills)*
- **Root**: `README.md`, `SKILLS_CATALOG_VI.md`
- **Core workflow**: `conductor`, `new-conversation`, `update-knowledge`, `handoff`, `done-checklist`, `review-plan`
- **Track workflow**: `brainstorm-track`, `planner-track`, `module-workflow`, `refactor-workflow`
- **QA/Execution**: `qa-verify-expert`, `frontend-standard-v1`, `zero-loop-dev`, `deploy-track`
- **Architecture**: `backend-architect`, `frontend-architect`, `system-architect`, `backend-development`, `frontend-development`, `frontend-design`, `frontend-qa-gatekeeper`, `performance-engineer`, `security-engineer`
- **Analysis**: `requirements-analyst`, `technical-writer`, `tech-stack-researcher`, `refactoring-expert`, `code-review`, `learning-guide`, `red-team-reviewer`
- **Debugging**: `debugging-defense-in-depth`, `debugging-root-cause-tracing`, `debugging-systematic-debugging`, `debugging-verification-before-completion`, `systematic-debugging`, `verification-before-completion`, `when-stuck`
- **Thinking frameworks**: `collision-zone-thinking`, `inversion-exercise`, `meta-pattern-recognition`, `scale-game`, `simplification-cascades`
- **Tools/Infra**: `alembic-workflow`, `postgresql-psql`, `cloudflare-r2`, `pdf-generation`, `repomix`, `docs-seeker`, `mcp-builder`, `claude-code`, `skill-creator`
- **UI/Styling**: `shadcn-ui`, `tailwindcss`
- **ATU-specific**: `atu-compact`, `atu-hub-components`, `atu-react-component`, `atu-summary-status`, `atu-typo-standard`

**.codex/skills/**
- `{conductor,new-conversation,update-knowledge,handoff}`
- `{brainstorm-track,planner-track,module-workflow,refactor-workflow}`
- `zero-loop-dev`, `deploy-track`
...
Kit này đóng gói conductor runtime + **toàn bộ skill library** cho 3 CLI tools trong 1 git repo portable.
...
**.agents/skills/**
- Core: `atu-conductor`, `atu-new-conversation`, `atu-update-knowledge`, `atu-handoff`
- Track: `brainstorm-track`, `planner-track`, `module-workflow`, `refactor-workflow`
- QA & Execution: `qa-verify-expert`, `frontend-standard-v1`, `zero-loop-dev`, `deploy-track`

**.claude/skills/** *(mở rộng trong v3.5 — 58 skills)*
- Core workflow, track, QA, execution
- Architecture, debugging, thinking frameworks
- Tools/infra, UI/styling, ATU-specific skills
- Xem `SKILLS_CATALOG_VI.md` để có danh sách đầy đủ

**.codex/skills/**
- Core: `{conductor,new-conversation,update-knowledge,handoff}`
- Track: `{brainstorm-track,planner-track,module-workflow,refactor-workflow}`
- Execution: `zero-loop-dev`, `deploy-track`
